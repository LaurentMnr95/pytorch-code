...
import os
# TODO: 
# On options : visdom, gpus, valtest
# On attacks: code PGD, C&W, DFOs with same signature
# On train on argparse: resume, model to load, lr ,epochs
# on test : path du fichier, attacks,
...
class options_test:
    def __init__(self):
        ...
        self.path_to_model = "/private/home/laurentmeunier/models/wide-resnet-28x20_CIFAR10/BEST.t7"
        # self.add_argument('-e', '--evaluate', dest='evaluate', action='store_true',
        #                     help='evaluate model on validation set')
        # self.add_argument('--pretrained', dest='pretrained', action='store_true',
        #                     help='use pre-trained model')
